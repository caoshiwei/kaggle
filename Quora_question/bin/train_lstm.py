...
from keras.layers import Embedding, Conv1D, Dense, SpatialDropout1D, Input, LSTM, Bidirectional
...
check_point = ModelCheckpoint(chk_poi_file, monitor='val_loss', verbose=1, period=5)


def data_genrator(X1, X2, y, batch_size=32):
    data_size = len(y)
